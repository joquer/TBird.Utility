...
namespace TBird.Utility.Test
{
    ...
    public class TypeUtilsTest
    {
        ...
        public void CompareObjects_CompareFlatObjectAllFieldsDifferent_ReturnsMessageList()
        {
            ...
            Collection<string> messages = TypeUtils.CompareObjects("FlatTestObject", left, right);
            Assert.AreEqual(4, messages.Count, TypeUtils.FlattenMessages("FlatTestObject", messages));
        }
        ...
        {
            FlatTestObject left = new FlatTestObject() { BoolValue = true, IntValue = 5, DoubleValue = 12.2, StringValue = "String", };
            Collection<string> messages = TypeUtils.CompareObjects("FlatTestObject", left, left);
            Assert.AreEqual(0, messages.Count, TypeUtils.FlattenMessages("FlatTestObject", messages));
        }
        ...
        public void CompareObjects_CompareObjectAndObjectAccessor_ReturnsEmptyList()
        {
            ...
            messages = TypeUtils.CompareObjects("FlatTestObject", left2, right2);
            Assert.AreEqual(0, messages.Count, TypeUtils.FlattenMessages("FlatTestObject", messages));
        }
        ...
        public void CompareObjects_CompareNestedObjectAllFieldsDifferent_ReturnsMessageList()
        {
            ...
            Collection<string> messages = TypeUtils.CompareObjects("NestedTestObject", left, right);
            Assert.AreEqual(4, messages.Count, TypeUtils.FlattenMessages("NestedTestObject", messages));
        }
        ...
        public void CompareObjects_CompareNestedObjectAllFieldsEqual_ReturnsEmptyList()
        {
            ...
            Collection<string> messages = TypeUtils.CompareObjects("NestedTestObject", left, left);
            Assert.AreEqual(0, messages.Count, TypeUtils.FlattenMessages("NestedTestObject", messages));
        }

        [Test]
        public void CompareObjects_CompaerObjectsWithArray_ObjectsEqual()
        {
            ObjectWithArray owa = new ObjectWithArray() { StringArray = new string[] { "one", "two", "three" }, };
            Collection<string> messages = TypeUtils.CompareObjects(owa.GetType().Name, owa, owa);
            Assert.AreEqual(0, messages.Count, TypeUtils.FlattenMessages(owa.GetType().Name, messages));
        }
        ...
        public void CompareObjects_CompareObjectWithList_ReturnsEmptyList()
        {
            ...
            Collection<string> messages = TypeUtils.CompareObjects("ObjectWithList", left, left);
            Assert.AreEqual(0, messages.Count, TypeUtils.FlattenMessages("ObjectWithList", messages));
        }
        ...
        public void CompareObjects_CompareObjectWithList_ItemsAreDifferent()
        {
            ...
            Collection<string> messages = TypeUtils.CompareObjects("ObjectWithList", left, right);
            Assert.AreEqual(8, messages.Count, TypeUtils.FlattenMessages("ObjectWithList", messages));
        }
        ...
        public void CompareObjects_CompareObjectWithList_ListsAreOfDifferentLengths()
        {
            ...
            Collection<string> messages = TypeUtils.CompareObjects("ObjectWithList", left, right);
            Assert.AreEqual(1, messages.Count, TypeUtils.FlattenMessages("ObjectWithList", messages));
        }
        [Test]
        ...
        public void CompareObjects_CompaerObjectsWithUri_ObjectsEqual()
        {
            ...
            Collection<string> messages = TypeUtils.CompareObjects(owu.GetType().Name, owu, owu);
            Assert.AreEqual(0, messages.Count, TypeUtils.FlattenMessages(owu.GetType().Name, messages));
        }
    }
}
